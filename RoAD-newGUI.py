...
command_relx=0.5
deltay=0.08
command_rely_start=0.6

text_input.place(relx=0.0, rely=0.0)
text_output.place(relx=0.5, rely=0.0)

labelFile.place(relx=command_relx, rely=command_rely_start)
place.place(relx=command_relx, rely=command_rely_start+deltay)
pick.place(relx=command_relx, rely=command_rely_start+deltay*2)
corn.place(relx=command_relx, rely=command_rely_start+deltay*3)
image.place(relx=command_relx, rely=command_rely_start+deltay*4)
...
def show_entry_fields():
    data = dict(
      day_th_1_= int(e1.get()),
      day_th_2_= int(e2.get()),
      day_th_3_= int(e3.get()),
      slower_drought_= int(e4.get())
      )
    with open('data.yml', 'w') as outfile:
      yaml.dump(data, outfile, default_flow_style=False)

lable1 = Label(mGui, text="day_th_1")
lable1.place(relx=0, rely=command_rely_start)
e1 = Entry(mGui)
e1.place(relx=entry_relx, rely=command_rely_start)

lable2 = Label(mGui, text="day_th_2")
lable2.place(relx=0, rely=command_rely_start+deltay)
e2 = Entry(mGui)
e2.place(relx=entry_relx, rely=command_rely_start+deltay)

lable2 = Label(mGui, text="day_th_3")
lable2.place(relx=0, rely=command_rely_start+deltay*2)
e3 = Entry(mGui)
e3.place(relx=entry_relx, rely=command_rely_start+deltay*2)

lable3 = Label(mGui, text="drought_mode")
lable3.place(relx=0, rely=command_rely_start+deltay*3)
e4 = Entry(mGui)
e4.place(relx=entry_relx, rely=command_rely_start+deltay*3)

configure = Button(mGui, text="configure", command=show_entry_fields)
configure.place(relx=entry_relx, rely=command_rely_start+deltay*4)
